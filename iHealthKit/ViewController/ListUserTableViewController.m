...
#import "View/UserTableViewCell.h"
#import "UserViewController.h"

@interface ListUserTableViewController ()

@property (nonatomic, strong) NSArray* listUser;

@end

@implementation ListUserTableViewController
...
- (void)viewDidLoad
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"UserTableViewCell"
